...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  RcpResponse getUser(TraceContext tc, i32 id)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	case "getUser":
		...
		argvalue0 := user_service.NewTraceContext()
		err10 := argvalue0.Read(context.Background(), jsProt9)
		if err10 != nil {
			Usage()
			return
		}
		value0 := user_service.TraceContext(argvalue0)
		...
		value1 := argvalue1
		fmt.Print(client.GetUser(context.Background(), value0, value1))
		fmt.Print("\n")
		break
	case "":
		Usage()
